...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(count) =>
      "${Intl.plural(count, zero: 'Heute', one: 'vor ${count} Tag', other: 'vor ${count} Tagen')}";

  static m3(count) => "${Intl.plural(count, other: '')}";

  static m4(count) => "${Intl.plural(count, other: '')}";
  ...
  static m8(count) =>
      "${Intl.plural(count, zero: 'In einer Stunde', one: 'vor ${count} Stunde', other: 'vor ${count} Stunden')}";
  ...
  static m12(count) =>
      "${Intl.plural(count, zero: 'Gerade jetzt', one: 'vor ${count} Minute', other: 'vor ${count} Minuten')}";
  ...
  static m21(count) => "${Intl.plural(count, other: '')}";
  ...
  static m24(count) =>
      "${Intl.plural(count, zero: '0 Sekunden', one: '${count} Sekunde', other: '${count} Sekunden')}";

  static m25(count) =>
      "${Intl.plural(count, zero: 'Gerade Jetzt', one: 'vor ${count} Sekunde', other: 'vor ${count} Sekunden')}";
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "boostVolume": MessageLookupByLibrary.simpleMessage("Volumen erhöhen"),
        ...
        "cellularConfirmDes": MessageLookupByLibrary.simpleMessage(
            "Sind Sie sicher, dass Sie Zellulardaten zum Herunterladen verwenden möchten?"),
        ...
        "fonts": MessageLookupByLibrary.simpleMessage(""),
        "from": m5,
        ...
        "playerHeightMed": MessageLookupByLibrary.simpleMessage("Mittel"),
        "playerHeightShort": MessageLookupByLibrary.simpleMessage("Niedrig"),
        "playerHeightTall": MessageLookupByLibrary.simpleMessage("Hoch"),
        "playing": MessageLookupByLibrary.simpleMessage(""),
        "plugins": MessageLookupByLibrary.simpleMessage(""),
        "podcast": m21,
        ...
        "settingsLanguages": MessageLookupByLibrary.simpleMessage(""),
        ...
        "skipSilence":
            MessageLookupByLibrary.simpleMessage("Schweigen überspringen"),
        ...
        "translators": MessageLookupByLibrary.simpleMessage("Übersetzerinnen"),
