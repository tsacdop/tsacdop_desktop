...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(count) => "${Intl.plural(count, zero: 'I dag', one: '${count} dager siden', other: '${count} dager siden')}";

  static m3(count) => "${Intl.plural(count, zero: 'Aldri', one: '${count} dag', other: '${count} dager')}";

  static m4(count) => "${Intl.plural(count, zero: '', one: 'Episode', other: 'Episoder')}";
  ...
  static m8(count) => "${Intl.plural(count, zero: 'Om en time', one: '${count} timer siden', other: '${count} timer siden')}";
  ...
  static m12(count) => "${Intl.plural(count, zero: 'Akkurat nå', one: '${count} minutter siden', other: '${count} minutter siden')}";
  ...
  static m21(count) => "${Intl.plural(count, zero: '', one: 'Podkast', other: 'Podkaster')}";
  ...
  static m25(count) => "${Intl.plural(count, zero: 'Akkurat nå', one: '${count} sekunder siden', other: '${count} sekunder siden')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "featureDiscoveryEditGroup" : MessageLookupByLibrary.simpleMessage("Trykk for å redigere gruppe"),
    "featureDiscoveryEditGroupDes" : MessageLookupByLibrary.simpleMessage("Du kan endre gruppenavn eller slette gruppe her, men hjemmegruppen kan ikke redigeres eller slettes\n"),
    ...
    "groupRemoveConfirm" : MessageLookupByLibrary.simpleMessage("Er du sikker på at du vil slette denne gruppen? Podkaster vil bli flyttet til Hjemmegruppen."),
    "groups" : m6,
    ...
    "introSecondPage" : MessageLookupByLibrary.simpleMessage("Abonnere på en podkast ved bruk av søk eller importer en OPML fil."),
    "introThirdPage" : MessageLookupByLibrary.simpleMessage("Du kan lage en ny gruppe for podkaster."),
    ...
    "noShownote" : MessageLookupByLibrary.simpleMessage("Fortsatt ingen shownotater mottatt for denne episoden."),
    ...
    "refreshArtwork" : MessageLookupByLibrary.simpleMessage("Oppdater kunstverk"),
    ...
    "settingsBackup" : MessageLookupByLibrary.simpleMessage("Sikkerhetskopi"),
    "settingsBackupDes" : MessageLookupByLibrary.simpleMessage("Sikkerhetskopi av app data"),
    ...
    "settingsLanguagesDes" : MessageLookupByLibrary.simpleMessage("Endre språk"),
    ...
    "settingsTapToOpenPopupMenu" : MessageLookupByLibrary.simpleMessage("Trykk for å åpne oppsprettsmeny"),
    "settingsTapToOpenPopupMenuDes" : MessageLookupByLibrary.simpleMessage("Du må trykke lenge for å åpne episoden"),
    ...
    "toastImportSettingsSuccess" : MessageLookupByLibrary.simpleMessage("Vellykket importering av innstillinger"),
    "toastOneGroup" : MessageLookupByLibrary.simpleMessage(""),
    "toastPodcastRecovering" : MessageLookupByLibrary.simpleMessage("Gjennoppretter, venligst vent "),
    "toastReadFile" : MessageLookupByLibrary.simpleMessage(""),
    "toastRecoverFailed" : MessageLookupByLibrary.simpleMessage("Podkast gjennopprettning feilet"),
